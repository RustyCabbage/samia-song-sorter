...
const SONG_COLLECTIONS = {
  preBaby: Object.freeze(["Welcome to Eden", "The Night Josh Tillman Listened To My Song", "Someone Tell the Boys", "Django", "21", "Milk", "Lasting Friend", "Paris", "Ode to Artifice", "Never Said", "Gotta Have You"]),

  theBaby: Object.freeze(["Pool", "Fit N Full", "Big Wheel", "Limbo Bitch", "Stellate", "Triptych", "Does Not Heal", "Waverly", "Winnebago", "Minnesota", "Is There Something In The Movies?"]),

  scout: Object.freeze(["As You Are", "Show Up", "Elephant", "The Promise"]),

  honey: Object.freeze(["Kill Her Freak Out", "Charm You", "Pink Balloon", "Mad at Me", "Sea Lions", "To Me It Was", "Breathing Song", "Honey", "Nanana", "Amelia", "Dream Song"]),

  bloodless: Object.freeze(["Biscuits Intro", "Bovine Excision", "Hole in a Frame", "Lizard", "Dare", "Fair Game", "Spine Oil", "Craziest Person", "Sacred", "Carousel", "Proof", "North Poles", "Pants"]),

  nonAlbumSingles: ["Desperado", "Born on a Train", "Maps", "Country", "Making Breakfast"]
};
